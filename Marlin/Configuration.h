...
#define STRING_CONFIG_H_AUTHOR "(Lee Harris, 20221022)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 1 //TronxyX5S_2e Wifi header Port 3
...
#define Z_MIN_ENDSTOP_INVERTING false  // Set to true to invert the logic of the endstop. //OEM True. BLTouch False
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 348, 348 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 200, 200 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 5000, 30, 10000, 10000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.022 // (mm) Distance from real junction edge. LH- Default 0.013
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, 24, -3.4 }  //TronxyX5S-2e check location of probe for adapter used [x,y,z]
 ...
 */
//#define LCD_BED_LEVELING  //LH 1652 bytes
...
//#define LCD_BED_TRAMMING  //LH 636 bytes
