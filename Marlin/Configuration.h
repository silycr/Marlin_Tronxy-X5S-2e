...
#define STRING_CONFIG_H_AUTHOR "(Lee Harris, 20221020)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -5, 0 }  //TronxyX5S-2e check location of probe for adapter used
